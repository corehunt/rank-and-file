...
class MemberSponsLegislationServiceTest {
    ...
    void setUp() throws Exception {
        ...
        memberSponsLegislationService = new MemberSponsLegislationService(webClient, sponsoredLegislationProcessor, sponsoredLegislationRepository);
    }
    ...
    void testGetSponsoredLegislationByPersonIdSuccessfulRetrieval() throws Exception {
        ...
        String responsePage2 = "{\"sponsoredLegislation\": [{}]}";
        ...
        // Execute the method
        List<SponsoredLegislation> result = memberSponsLegislationService.getSponsoredLegislationByPersonId(personId, limit);
        ...
        assertTrue(request1.getPath().contains("member/" + personId + "/sponsored-legislation"));
        assertTrue(request2.getPath().contains("member/" + personId + "/sponsored-legislation"));

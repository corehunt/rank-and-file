package com.rankandfile.backend.service.external.person;
...
public class CongressClassPersonService {
    ...
    public List<Person> fetchMembersOfCurrentCongress(String congressNo, int limit) {
        ...
        try {
            ...
            log.error("An error occured while fetching and processing members for Congress number: {}", congressNo, e);
            throw e;
        }

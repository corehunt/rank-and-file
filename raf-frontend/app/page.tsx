...
export default function Home() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative h-screen flex items-center overflow-hidden bg-gradient-to-b from-background to-muted/30">
        <div className="absolute inset-0 bg-grid-slate-900/[0.04] bg-[size:32px] dark:bg-grid-slate-400/[0.05]" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center space-y-4 sm:space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-base sm:text-xl text-muted-foreground max-w-2xl mx-auto px-4">
              Track U.S. politicians' legislative activities, sponsorships, donors, and financial disclosures with unprecedented clarity.
            </p>
      ...
      <section className="py-12 sm:py-24 bg-muted/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
            <div className="bg-background p-5 sm:p-8 rounded-xl shadow-sm border hover:border-primary/50 transition-colors">
